...
public class EnterMarks extends JFrame implements ActionListener {
    ...
    add(image);
        ...
        JLabel lblentermarks=new JLabel("Select Semester");
        ...
        submit.setBounds(70,360,200,25);
        ...
        cancel.setBounds(280,360, 200, 25);
    ...
    public void actionPerformed(ActionEvent ae)
    {
        if(ae.getSource()==submit) {
            try 
            {
              ...
              String query2="insert into marks value('"+crollno.getSelectedItem()+"','"+cbsemester.getSelectedItem()+"','"+tfmarks1.getText()+"','"+tfmarks2.getText()+"','"+tfmarks3.getText()+"','"+tfmarks4.getText()+"','"+tfmarks5.getText()+"')";
